...
[![Open in Streamlit](https://img.shields.io/badge/Streamlit-Run%20Locally-FF4B4B?logo=streamlit)](#run-locally)
...
- If you deploy the app later, replace the Streamlit badge link with the live app URL
